...
| 脚注 | ` 三个反引号（(``` ）或三个波浪号（~~~） ` | [脚注语法](#script) |  |
| 标题编号 | ` 三个反引号（(``` ）或三个波浪号（~~~） ` | [标题语法](#title)|  |
| 定义列表 | ` 三个反引号（(``` ）或三个波浪号（~~~） ` | [定义列表语法](#define-list)|  |
| 删除线 | ` 三个反引号（(``` ）或三个波浪号（~~~） ` | [删除线语法](#delete)|  |
| 任务列表语法 | ` 三个反引号（(``` ）或三个波浪号（~~~） ` | [任务列表语法](#task)|  |
| Emoji表情 | ` 三个反引号（(``` ）或三个波浪号（~~~） ` |[Emoji语法](#emoji) |  |
